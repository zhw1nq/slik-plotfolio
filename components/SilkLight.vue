...
void main() {
  ...
  // Light mode: nền trắng với silk màu tối
  vec3 bgColor = vec3(1.0, 1.0, 1.0);
  vec3 silkColor = uColor * pattern - rnd / 15.0 * uNoiseIntensity;

  // Mix giữa background trắng và silk color (alpha nhẹ hơn)
  float alpha = 0.4;
  vec3 finalColor = mix(bgColor, silkColor, pattern * alpha);
...
<template>
  <div ref="containerRef" class="silk-container silk-light" />
</template>
